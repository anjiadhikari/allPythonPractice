...
def write_happy_inside_circle(text_color, x, y):
    ...
    my_turtle_cursor.write("Happy", font=("sans-serif", 22, "bold"))
...
def write_birthday_inside_circle(text_color, x, y):
    ...
    my_turtle_cursor.write("Birthday", font=("sans-serif", 22, "bold"))

    my_turtle_cursor.getscreen().update()


def write_sanu_inside_circle(text_color, x, y):
    my_turtle_cursor.penup()
    # Changing color of our cursor
    my_turtle_cursor.color(text_color)
    ...
    my_turtle_cursor.write("Sanu❤️❤️", font=("sans-serif", 22, "bold"))
...
draw_circle_on_top_of_stick("#181A18", "#FFFDD0", 100, y_coordinate + 200, 100)

# Writing "Happy" inside of our circle
write_happy_inside_circle("#000000", -55, y_coordinate + 240)

# Writing "Birthday" inside of our circle
write_birthday_inside_circle("#000000", -80, y_coordinate + 190)

# Writing "sanu" inside of our circle
write_sanu_inside_circle("#000000", -70, y_coordinate + 150)

# turtle.goto(100,100)
# turtle.write("Hello, World!",move=False)
# turtle.write("Happy Birthday Sanu", move=False,font=("Verdana",15, "normal"))
